...
export const initialAmbulances = [
  {
    ...
    driverPhone: '+91 98231 45670',
    driverPhoto: 'https://api.dicebear.com/7.x/personas/svg?seed=RameshKumar',
  ...
  },
  {
    ...
    driverPhoto: 'https://api.dicebear.com/7.x/personas/svg?seed=SureshPatil',
  ...
  },
  {
    ...
    driverPhoto: 'https://api.dicebear.com/7.x/personas/svg?seed=AnitaDeshmukh',
    type: 'Cardiac Care',
    lat: 18.5220,
    lng: 73.8690,
    status: 'available',
  ...
  },
  {
    ...
    driverPhoto: 'https://api.dicebear.com/7.x/personas/svg?seed=VikramSingh',
    type: 'Basic Life Support',
    lat: 18.5110,
    lng: 73.8450,
    status: 'busy',
  ...
  },
  {
    ...
    driverPhone: '+91 80909 12345',
    driverPhoto: 'https://api.dicebear.com/7.x/personas/svg?seed=PoojaHegde',
    type: 'Advance Life Support',
    lat: 18.5140,
    lng: 73.8360,
    status: 'available',
